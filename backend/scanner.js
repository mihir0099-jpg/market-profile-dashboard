...
const ALL_SYMBOLS = [
  "NSE:NIFTY", "NSE:BANKNIFTY", "NSE:NIFTY1!", "TVC:USOIL", "OANDA:XAUUSD", "COINBASE:BTCUSD", "DELTAIN:BTCUSD.P", "NSE:360ONE", "NSE:ABB",
...
const isRenderCloud = Boolean(process.env.RENDER || process.env.NODE_ENV === 'production');
const symbols = isRenderCloud ? [
  "NSE:NIFTY", "NSE:BANKNIFTY", "NSE:NIFTY1!", "TVC:USOIL", "NSE:RELIANCE", "NSE:HDFCBANK", "NSE:ICICIBANK", "NSE:SBIN",
  "NSE:TCS", "NSE:INFY", "NSE:AXISBANK", "NSE:KOTAKBANK", "NSE:LT", "NSE:ITC", "NSE:BHARTIARTL", "NSE:MARUTI", "NSE:BAJFINANCE",
  "NSE:SUNPHARMA", "NSE:TATAMOTORS", "NSE:TATASTEEL", "NSE:HINDUNILVR", "NSE:ASIANPAINT", "NSE:TITAN", "NSE:ULTRACEMCO", "NSE:JSWSTEEL",
  "NSE:POWERGRID", "NSE:NTPC", "NSE:ONGC", "NSE:COALINDIA", "NSE:BPCL", "NSE:HEROMOTOCO", "NSE:EICHERMOT", "NSE:BAJAJ_AUTO",
  "NSE:M_M", "NSE:WIPRO", "NSE:HCLTECH", "NSE:LTIM", "NSE:TECHM"
] : ALL_SYMBOLS;
